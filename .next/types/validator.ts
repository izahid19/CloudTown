...
// Validate ../../app/api/ably-token/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/ably-token">> = Specific
  const handler = {} as typeof import("../../app/api/ably-token/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
