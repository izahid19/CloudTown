...
export default class BootScene extends Phaser.Scene {
  ...
  createPlaceholderAssets() {
    ...
    this.textures.addSpriteSheet('player', playerCanvas as unknown as HTMLImageElement, { frameWidth: 32, frameHeight: 32 });
    
    // Create tree sprite - Cherry blossom style
